...
namespace ExwhyzeeEDI.Web.Models.Entities
{
    ...
    //public class PlaceValidator : AbstractValidator<YoungMind>
    //{
    //    public PlaceValidator()
    //    {
    //        RuleFor(x => x.Email).Must(BeUniqueUrl).WithMessage("Email already exists");
    //    }

    //    private bool BeUniqueUrl(string url)
    //    {
    //        return new ApplicationDbContext().YoungMinds.FirstOrDefault(x => x.Email == url) == null;
    //    }
    //}
}